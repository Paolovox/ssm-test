...
$app->group('/registrazioni_attivita_np', function (RouteCollectorProxy $groupAttivitaNP) use ($auth, $args) {
  ...
  $data = [
    ...
    "list_fields" => [ "ssm.ssm_scuole_attivita_np.id", "ssm.ssm_scuole_attivita_np.nome_attivita",
    ]
  ];
  ...
  // get
  $groupAttivitaNP->get('/contatori/{idscuola_specializzazione}/{idcoorte}', function (Request $request, Response $response, $args) use ($crud) {
    $log = new Logger();
  ...
  // get
  $groupAttivitaNP->get('/contatori/{idscuola_specializzazione}/{idcoorte}/{id}', function (Request $request, Response $response, $args) use ($crud) {
      $Utils = new Utils();
      $log = new Logger();
  ...
  // new
  $groupAttivitaNP->put('/contatori/{idscuola_specializzazione}/{idcoorte}/{id}', function (Request $request, Response $response, $args) use ($crud) {
    $Utils = new Utils();
    $log = new Logger();
    $uuid = new UUID();
  ...
  // delete
  $groupAttivitaNP->delete('/contatori/{idscuola_specializzazione}/{idcoorte}/{id}', function (Request $request, Response $response, $args) use ($crud) {
    $log = new Logger();
