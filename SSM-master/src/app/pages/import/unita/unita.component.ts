...
@Component({
  ...
  styleUrls: ['./unita.component.scss']
})
export class AssociazioneUnitaComponent implements OnInit, OnDestroy {

  path = 'import/associazione/unita';
  idAzienda: string;
  idPresidio: string;
  totalElement: number;
  pageElement = 0;
  ...
  @ViewChild('unitaAssociazioneTable') unitaAssociazioneTable: OGListComponent;
  ...
  getAziende() {
    const obj: Rest = {
      type: 'GET',
      path: `import/associazione/presidi/aziende`
    };
    this.main.rest(obj)
      .then((res: any) => {
  ...
  getPresidi(azienda) {
    ...
    const obj: Rest = {
      type: 'GET',
      path: `${this.path}/presidi`,
      queryParams: {
        idazienda_ext: azienda.idazienda_ext
      }
    };
    this.main.rest(obj)
      .then((res: any) => {
  ...
  getUnita(presidio: any, e?) {
    ...
    const obj: Rest = {
      ...
      queryParams: {
        ...
        idpresidio_ext: presidio ? presidio.idpresidio_ext : this.presidio.idpresidio_ext,
        idpresidio: presidio ? presidio.idpresidio : this.presidio.idpresidio,
        idazienda_ext: this.azienda.idazienda_ext,
        idazienda: this.azienda.idazienda
      }
    };
    this.main.rest(obj)
      .then((res: any) => {
        this.unita = res.unita;
        this.unitaAll = res.unita_all;
  ...
  getData(reset = false, loading = true) {
    ...
    this.unitaAssociazioneTable.clearSelection();
    const obj: Rest = {
      path: `${this.path}`,
      type: 'GET'
    };
    ...
    this.main.rest(obj)
      .then((res: any) => {
        ...
        if (reset) {
          this.unitaAssociazioneTable.firstPage();
        }
      }, () => {
        if (loading) {
          this.main.loaderOff();
